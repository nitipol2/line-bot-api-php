 ...
 foreach ($request_array['events'] as $event)
 {
  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		if(($text == "อยากทราบยอดผู้ติดเชื้อ COVID-19")||($text == "COVID-19")||($text == "COVID-19")){
		...
		{
			 $reply_message = 'ระบบได้รับข้อความ ('.$text.') ของคุณแล้ว แต่ไม่มีคำตอบนี้ในระบบ โปรดถามคำถามว่า "อยากทราบยอดผู้ติดเชื้อ COVID-19" หรือ "ข้อมูลส่วนตัว" ';
    		}
